...
var passwordManagement_1 = require("../security/passwordManagement");
function checkThatUserSignUpCredentialsOrThrow(email, password, phoneNumber, username) {
    var pn = new awPhoneNumber(phoneNumber, 'SE');
...
function checkThatPasswordsAreEqualsOrThrow(password, confirmedPassword) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, passwordManagement_1.isSame)(confirmedPassword, password)];
                case 1:
                    if (!(_a.sent())) {
...
function checkThatDataisInserted(data) {
    if (data == util_1.errorCode) {
        throw new CustomError_1.CustomError(util_1.errorCode, util_1.dataFailedToInsert, {});
    }
}
exports.checkThatDataisInserted = checkThatDataisInserted;
function checkThatDataExist(data) {
    if (!data) {
        throw new CustomError_1.CustomError(util_1.NONE_CODE, util_1.nodata, {});
    }
}
exports.checkThatDataExist = checkThatDataExist;
