...
var PlantUserResponse_1 = require("../../response/PlantUserResponse");
var UserRepository_1 = __importDefault(require("../../repository/UserRepository"));
var checkdata_1 = require("../../util/validator/checkdata");
var getUserPlant = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, execute(username)];
            case 1:
                result = _c.sent();
                console.log(result);
...
var execute = function (username) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, PlantUserRepository_1.default.findByUsername(username)];
            case 2:
                result = _a.sent();
                ...
                return [2 /*return*/, (0, PlantUserResponse_1.plantUserToResponse)(result['Items'][0])];
        }
    });
}); };
