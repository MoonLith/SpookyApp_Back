...
exports.getPlantTypeByName = void 0;
var tokenManagement_1 = require("../../util/security/tokenManagement");
var CustomError_1 = require("../../util/error/CustomError");
var PlantRepository_1 = __importDefault(require("../../repository/PlantRepository"));
var UserRepository_1 = __importDefault(require("../../repository/UserRepository"));
var checkdata_1 = require("../../util/validator/checkdata");
var PlantResponse_1 = require("../../response/PlantResponse");
var getPlantTypeByName = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token, _a, userId, username, plantName, result, err_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, execute(userId, username, plantName)];
            case 1:
                result = _c.sent();
                console.log(result);
...
exports.getPlantTypeByName = getPlantTypeByName;
var execute = function (email, username, plantName) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, PlantRepository_1.default.findByName(plantName)];
            case 2:
                result = _a.sent();
                return [2 /*return*/, (0, PlantResponse_1.plantToResponse)(result['Items'][0])];
        }
    });
}); };
