...
var killPlant = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token, _a, userId, username, plantUserId, user, err_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                plantUserId = req.body.plantUserId;
                return [4 /*yield*/, execute(username, userId, plantUserId)];
            case 2:
                user = _c.sent();
...
exports.killPlant = killPlant;
var execute = function (username, userId, plantUserId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, PlantUserRepository_1.default.killPlant(plantUserId, true)];
            case 2:
                result = _a.sent();
