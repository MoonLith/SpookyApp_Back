...
exports.getPlantTypeById = void 0;
...
var getPlantTypeById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token, _a, userId, username, plantId, result, err_1;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, execute(userId, username, plantId)];
            case 1:
                result = _c.sent();
                console.log(result);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, PlantRepository_1.default.findById(plantName)];
            case 2:
                result = _a.sent();
