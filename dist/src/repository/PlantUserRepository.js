...
var PlantUserRepository = /** @class */ (function () {
    function PlantUserRepository() {
    }
    PlantUserRepository.findByUsername = function (username) {
    ...
    PlantUserRepository.insert = function (plant) {
        return __awaiter(this, void 0, void 0, function () {
            var params, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PlantUserRepository.killPlant = function (id, isKilled) {
        return __awaiter(this, void 0, void 0, function () {
            var params, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, dynamoDB.updateItem(params).promise()];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        e_3 = _a.sent();
                        console.log(e_3);
    ...
    return PlantUserRepository;
}());
exports.default = PlantUserRepository;
