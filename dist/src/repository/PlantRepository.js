...
var PlantRepository = /** @class */ (function () {
    function PlantRepository() {
    }
    PlantRepository.findFirst100 = function () {
    ...
    PlantRepository.findByName = function (nameFlower) {
        return __awaiter(this, void 0, void 0, function () {
            var params, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PlantRepository.findById = function (plantId) {
        return __awaiter(this, void 0, void 0, function () {
            var params, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = PlantRepository;
