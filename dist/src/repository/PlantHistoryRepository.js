...
var PlantHistoryRepository = /** @class */ (function () {
    function PlantHistoryRepository() {
    }
    PlantHistoryRepository.findByName = function (nameFlower) {
    ...
    PlantHistoryRepository.findById = function (device_id) {
        return __awaiter(this, void 0, void 0, function () {
            var params, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return PlantHistoryRepository;
}());
exports.default = PlantHistoryRepository;
